...
public class StaticData {
	...
	// public static String ORACLE_FILE =
	// "C:/MyWorks/Thesis Works/Crowdsource_Knowledge_Base/CodeTokenRec/RACK-Replication-Package/EMSE2018-Dataset/NL-Queries-&-Oracle.txt";
	public static String INDEX_FOLDER = "./IJDS-code-ext-splitted-index";
	// public static String INDEX_FOLDER =
	// "C:/MyWorks/Thesis Works/Crowdsource_Knowledge_Base/CodeTokenRec/RACK-Replication-package/IJDS-code-ext-splitted-index";
